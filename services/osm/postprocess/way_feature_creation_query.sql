-- public.way_feature definition

-- Drop table

-- DROP TABLE public.way_feature cascade;

CREATE TABLE if not exists public.way_feature (
...
from (select id, tags, generate_subscripts(tags, 1) as s from public.planet_osm_ways pow) as foo
